  ...
  const handleClick = async () => {
    try {
      ...
      if (result.isConfirmed) {
        try {
          await axios.post("https://shy-jade-clownfish.cyclic.app/apis/patients/", {...users,
            users_id: users.users_id, // เพิ่มบรรทัดนี้
          });
          ...
          Swal.fire({
            ...
            text: "เกิดข้อผิดพลาดในการสร้างผู้ใช้",
          ...
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              ...
              <li
                ...
                aria-current="page"
              >
                {location.state ? "แก้ไข" : "เพิ่ม"}ข้อมูลรายชื่อผู้ใช้
              </li>
            </ol>
          </nav>
        </div>
