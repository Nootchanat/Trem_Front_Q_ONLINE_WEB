...
function FormUser() {
  ...
  async function save(data) {
    let res = location.state ? await updateUser(location.state, data) : await createPatient(data);
    if (res) {
      if (res.statusCode === 200 && res.taskStatus) {
        Swal.fire({
          icon: "success",
      ...
      <div className="w-full">
        ...
        <Formik
          ...
          initialValues={{
            ...
            congenital_disease: data ? data.congenital_disease :"",
            drug_allergy : data ? data.drug_allergy:"",
            ...
            contact_relation_id: data ? data.contact_relation_id:"",
