...
function Dental() {
    ...
    const fetchData = async () => {
      try {
        const res1 = await axios.get(
          `https://quaint-culottes-dove.cyclic.app/apis/doctors/${DId}`
        );
  ...
  return (
    <div className="w-full">
      ...
      <div className="doctorindepatment">
        <div className="wrapper-page">
          <div className="centerdoctor">แพทย์ประจำแผนก</div>
          <div className="doctor-in-depart-card-container">
            <div className="card-doctor">
              <img src={doctor_image} className="doc-img " alt="" />
              <div>
                <b class="text-primary">
                 <h5 className="text-name-doctor ">ชื่อแพทย์ : 
                 นพ.{doctor_first_name} {doctor_last_name}</h5> 
                </b>
                <br />
                สถานะ : {doctor_status}
                <br />
