...
import {  updateUser, getDetailUser} from '../../../service/User.Service';
...
function EditProfile() {
  ...
  async function save(data) {
    ...
    let res = location.state ? await updateUser(location.state, formData) : await createPatient(formData);
    if (res) {
      if (res.statusCode === 200 && res.taskStatus) {
        Swal.fire({
          icon: 'success',
  ...
  return (
    <Fragment>
      <div className="w-full">
        <div className="d-flex justify-content-center1111">
